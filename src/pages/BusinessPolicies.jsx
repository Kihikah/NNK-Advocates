...
import "../styles/BusinessPolicies.css";
import HeroBg from "../assets/4.jpeg"; // change this to your actual image
...
const BusinessPolicies = () => {
  return (
    <div className="business-policies-page">
      {/* Hero Section */}
      <div
